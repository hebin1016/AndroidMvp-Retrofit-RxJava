...
public class SPUtils {
    ...
    public static void setApplication(Activity activity) {
        if (activity == null) {
            Log.d(TAG, "Setting activity_picture was null, please check this.");
            return;
        }
    ...
    public static boolean getBoolean(Application application, String name, String key, boolean defaultValue) {
        if (checkApplicationAndStrings(application, name, key)) {
    ...
    public static HashMap<String, Object> getValues(Application application, String name, HashMap<String, Object> keyTypes) {
        ...
        if (checkApplicationAndString(application, name)) {
            ...
            Iterator<Map.Entry<String, Object>> iter = keyTypes.entrySet().iterator();
            while (iter.hasNext()) {
